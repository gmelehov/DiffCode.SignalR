export class SRHubPage {
    ...
    openWindow(newurl, width = 800, height = 500) {
    ...
    init() {
         ...
         */
        this.hub.on('RcvMyConnection', (conn) => {
            console.clear();
         ...
         */
        this.hub.on('UpdMyConnection', (conn) => {
    ...
    pushCidToLocalStorage(cid) {
        let cids = JSON.parse(window.localStorage.getItem('cids')) || [];
